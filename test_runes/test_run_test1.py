...
from datas import valid_auth_number, worded_auth_number, wronge_auth_number
from datas import valid_login, empty_login, wronge_login, empty_mail, wronge_mail
from datas import valid_passwrd, valid_phone, name, last_name, valid_mail
from datas import empty_name, wronge_name, wronge_last_name, empty_passwrd
from datas import empty_last_name, empty_phone, wronge_phone, wronge_passwrd
